...
class Bd2FsNodeServicer(csi_pb2_grpc.NodeServicer):
    ...
    def NodePublishVolume(self, request, context):
        staging_dev = f"{request.staging_target_path}/dev"
    ...
    def NodeStageVolume(self, request, context):
        ...
        bd_publish_request.target_path = f"{request.staging_target_path}/dev"
    ...
    def NodeUnstageVolume(self, request, context):
        ...
        bd_unpublish_request.target_path = f"{request.staging_target_path}/dev"
    ...
    def NodeExpandVolume(self, request, context):
        ...
        if dev_path is None:
            dev_path = f"{request.volume_path}/dev"
